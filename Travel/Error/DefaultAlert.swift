...
struct DefaultAlert: Sendable, Error {
...
// MARK: - Decoding -
extension DefaultAlert: Decodable {
...
// MARK: - Default Errors -
extension DefaultAlert {
    static let badURL = DefaultAlert(
    ...
    static let encodeError = DefaultAlert(
    ...
    static let executionError = DefaultAlert(
    ...
    static let badResponse = DefaultAlert(
    ...
    static let unknownError = DefaultAlert(
    ...
    static let decodeError = DefaultAlert(
